...
public class redUnitTwoScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hit == GameObject.FindGameObjectWithTag("blueUnit") || hit2 == GameObject.FindGameObjectWithTag("blueUnit") || hit3 == GameObject.FindGameObjectWithTag("blueUnit"))
            {
                shoot = true;
                moveSpeed = 0;
            }
